...
./build/skew_test.o: ./test/skew_test.cpp ./src/bwtree.h
	$(CXX) ./test/skew_test.cpp -c -o ./build/skew_test.o $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG)
